...
fn test_execution_with_storage() {
    ...
    let privkey1 = ed25519::SigningKey::generate(&mut rng);
    ...
    let privkey2 = ed25519::SigningKey::generate(&mut rng);
    ...
    let pubkey3 = ed25519::SigningKey::generate(&mut rng).public_key();
    let account3_auth_key = AuthenticationKey::ed25519(&pubkey3);
    let account3 = account3_auth_key.derived_address();

    let pubkey4 = ed25519::SigningKey::generate(&mut rng).public_key();
