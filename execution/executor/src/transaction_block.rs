...
pub struct CommittableBlockBatch {
    blocks: Vec<CommittableBlock>,
    /// The signatures on the last block of this batch. Not all committed blocks will have
    /// signatures, if multiple blocks are committed at once.
