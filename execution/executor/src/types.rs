...
pub struct TransactionData {
    ...
    /// new blob.
    account_blobs: Arc<HashMap<AccountAddress, (HashValue, AccountStateBlob)>>,
...
impl TransactionData {
    pub fn new(
        account_blobs: HashMap<AccountAddress, (HashValue, AccountStateBlob)>,
        ...
        TransactionData {
            account_blobs: Arc::new(account_blobs),
    ...
    pub fn account_blobs(&self) -> Arc<HashMap<AccountAddress, (HashValue, AccountStateBlob)>> {
        self.account_blobs.clone()
    }

    pub fn events(&self) -> Arc<Vec<ContractEvent>> {
        self.events.clone()
    }
