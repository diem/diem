...
fn test_multi_ed25519_public_key_serialization() {
    ...
    let multi_key_31_bytes =
        multi_ed25519::VerifyingKeys::try_from(&[0u8; ED25519_PUBLIC_KEY_LENGTH - 1][..]);
    ...
    let multi_key_32_bytes =
        multi_ed25519::VerifyingKeys::try_from(&[0u8; ED25519_PUBLIC_KEY_LENGTH][..]);
    ...
    let multi_key_34_bytes =
        multi_ed25519::VerifyingKeys::try_from(&[0u8; ED25519_PUBLIC_KEY_LENGTH + 2][..]);
