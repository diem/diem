...
impl TryFrom<::proto_types::types::EpochChangeProof> for EpochChangeProof {
    type Error = Error;

    fn try_from(proto: ::proto_types::types::EpochChangeProof) -> Result<Self> {
...
impl From<EpochChangeProof> for ::proto_types::types::EpochChangeProof {
