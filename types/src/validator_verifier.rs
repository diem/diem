...
impl ValidatorConsensusInfo {
    pub fn new(public_key: ed25519::VerifyingKey, voting_power: u64) -> Self {
...
impl ValidatorVerifier {
    ...
    pub fn new_single(author: AccountAddress, public_key: ed25519::VerifyingKey) -> Self {
    ...
    pub fn verify_aggregated_signature(
        &self,
        hash: HashValue,
        aggregated_signature: &BTreeMap<AccountAddress, ed25519::Signature>,
    ) -> std::result::Result<(), VerifyError> {
    ...
    pub fn batch_verify_aggregated_signature(
        ...
        self.check_num_of_signatures(aggregated_signature)?;
        self.check_voting_power(aggregated_signature.keys())?;
        let keys_and_signatures: Vec<(ed25519::VerifyingKey, ed25519::Signature)> =
        ...
        if ed25519::VerifyingKey::batch_verify_signatures(&hash, keys_and_signatures).is_err() {
    ...
    pub fn get_public_key(&self, author: &AccountAddress) -> Option<ed25519::VerifyingKey> {
