...
fn test_program_canonical_serialization_example() {
    ...
    let expected_output: Vec<u8> = vec![
        ...
        0x64, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xCA, 0x02, 0x00, 0x00, 0x00, 0xFE,
        0xD0, 0x01, 0x00, 0x00, 0x00, 0x0D,
    ];
...
fn test_raw_transaction_with_a_program_canonical_serialization_example() {
    ...
    let expected_output = vec![
        ...
        0xA2, 0x63, 0x8A, 0x49, 0xB9, 0xEE, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x64, 0x30, 0x30, 0x64, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xCA, 0x02, 0x00,
        0x00, 0x00, 0xFE, 0xD0, 0x01, 0x00, 0x00, 0x00, 0x0D, 0x10, 0x27, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x20, 0x4E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x51, 0x01, 0x00, 0x00,
        0x00, 0x00, 0x00,
    ];
...
fn test_transaction_payload_with_a_program_canonical_serialization_example() {
    let input = TransactionPayload::Program(get_common_program());

    let expected_output = vec![
        0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x6D, 0x6F, 0x76, 0x65, 0x02, 0x00, 0x00,
        ...
        0x20, 0x64, 0x30, 0x30, 0x64, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xCA, 0x02,
        0x00, 0x00, 0x00, 0xFE, 0xD0, 0x01, 0x00, 0x00, 0x00, 0x0D,
    ];
