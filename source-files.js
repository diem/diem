...
sourcesIndex["language_e2e_tests"] = {"name":"","dirs":[{"name":"account_universe","files":["create_account.rs","peer_to_peer.rs","rotate_key.rs","universe.rs"]},{"name":"execution_strategies","files":["basic_strategy.rs","guided_strategy.rs","mod.rs","multi_strategy.rs","random_strategy.rs","types.rs"]}],"files":["account.rs","account_universe.rs","common_transactions.rs","compile.rs","data_store.rs","executor.rs","gas_costs.rs","keygen.rs","lib.rs","proptest_types.rs"]};
...
sourcesIndex["libra_fuzzer"] = {"name":"","dirs":[{"name":"fuzz_targets","files":["compiled_module.rs","consensus_proposal.rs","inbound_rpc_protocol.rs","inner_signed_transaction.rs","json_rpc_service.rs","network_noise_initiator.rs","network_noise_responder.rs","storage_schema_decode.rs","vm_value.rs"]}],"files":["commands.rs","fuzz_targets.rs","lib.rs"]};
