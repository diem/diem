...
<!-- [Coin.move](../../../code/toycoin/creating-coins/v1/modules/Coin.move) -->
```=
address 0x2 {
    module Coin {
...
<!-- [test-coin.move](../../../code/toycoin/creating-coins/v1/scripts/test-coin.move) -->
```=
script {
...
<!-- [Coin.move](../../../code/toycoin/creating-coins/v2/modules/Coin.move) -->
...
<!-- [test-coin.move](../../../code/toycoin/creating-coins/v2/scripts/test-coin.move) -->
...
<!-- [Coin.move](../../../code/toycoin/creating-coins/v3/modules/Coin.move) just
the resource struct -->
...
<!-- [test-burn.move](../../../code/toycoin/creating-coins/v3/scripts/test-burn.move) -->
...
<!--
things learned at the end:
- difference between modules and scripts
- difference between types and resources
- encapsulation properties of modules and their resources
- safety properties of resources
-->
