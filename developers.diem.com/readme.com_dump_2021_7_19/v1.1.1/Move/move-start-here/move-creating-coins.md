...
metadata: 
  title: "Creating coins"
  description: "Learn how to create, manage, and destroy coins using Move."
createdAt: "2021-02-04T01:03:45.398Z"
updatedAt: "2021-06-11T17:26:13.603Z"
---
...
The `burn` function uses pattern matching to unpack the `Coin` into just its internal value. This essentially destroys the resource and returns a normal `u64` value. We return the value of the coin to let the caller know how much money just disappeared. (see [structs and resources](doc:move-basics-structs-and-resources#destroying-structs-via-pattern-matching)).
