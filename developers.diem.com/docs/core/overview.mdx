...
<CardsWrapper>
  <SimpleTextCard
    ...
    title="JSON-RPC API"
    to="https://github.com/diem/diem/blob/master/json-rpc/json-rpc-spec.md"
  />
  <SimpleTextCard
    ...
    title="Python SDK"
    to="https://github.com/diem/libra-client-sdk-python"
  />
  <SimpleTextCard
    ...
    title="Java SDK"
    to="https://github.com/diem/libra-client-sdk-java"
  />
  <SimpleTextCard
    icon="img/go-sdk.svg"
    ...
    title="Go SDK"
    to="https://github.com/diem/libra-client-sdk-go"
  />
  <SimpleTextCard
