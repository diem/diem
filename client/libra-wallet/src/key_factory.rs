...
impl ExtendedPrivKey {
    ...
    pub fn new(_child_number: ChildNumber, private_key: ed25519::SigningKey) -> Self {
        Self {
            _child_number,
            private_key,
        }
    ...
    pub fn get_public(&self) -> ed25519::VerifyingKey {
...
impl KeyFactory {
    ...
    pub fn private_child(&self, child: ChildNumber) -> Result<ExtendedPrivKey> {
        ...
        let sk = ed25519::SigningKey::try_from(hkdf_expand.as_slice())
