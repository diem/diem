...
impl<V> FrozenTreeCache<V> {
    fn new() -> Self {
        Self {
            node_cache: HashMap::with_capacity(DEFAULT_ALLOC),
            stale_node_index_cache: HashSet::with_capacity(DEFAULT_ALLOC),
            node_stats: Vec::with_capacity(DEFAULT_ALLOC),
            root_hashes: Vec::with_capacity(DEFAULT_ALLOC),
        }
    }
}
