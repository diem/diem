...
data types are defined in [file_format.rs](https://github.com/diem/diem/blob/master/language/vm/src/file_format.rs).
...
then verified by the [bytecode verifier](https://github.com/diem/diem/blob/master/language/bytecode-verifier/README.md). The compiler command line
