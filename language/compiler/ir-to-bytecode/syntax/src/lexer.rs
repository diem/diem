                ...
                if !self.spec_mode {
                    match &text[len..].chars().next() {
                        ...
                        Some('<') => match name {
                            ...
                            "vec_empty" => (Tok::VecEmpty, len + 1),
                            "vec_len" => (Tok::VecLen, len + 1),
                            "vec_imm_borrow" => (Tok::VecImmBorrow, len + 1),
                            "vec_mut_borrow" => (Tok::VecMutBorrow, len + 1),
                            "vec_push_back" => (Tok::VecPushBack, len + 1),
                            "vec_pop_back" => (Tok::VecPopBack, len + 1),
                            "vec_destroy_empty" => (Tok::VecDestroyEmpty, len + 1),
                            "vec_swap" => (Tok::VecSwap, len + 1),
