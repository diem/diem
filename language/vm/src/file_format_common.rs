...
pub enum Opcodes {
    ...
    FREEZE_REF              = 0x36,
    IS_OFFCHAIN                 = 0x37,
    GET_TXN_RECEIVER            = 0x38,
    EXIST_SENDER_CHANNEL        = 0x39,
    EXIST_RECEIVER_CHANNEL      = 0x3A,
    BORROW_SENDER_CHANNEL       = 0x3B,
    BORROW_RECEIVER_CHANNEL     = 0x3C,
    MOVE_FROM_SENDER_CHANNEL    = 0x3D,
    MOVE_FROM_RECEIVER_CHANNEL  = 0x3E,
