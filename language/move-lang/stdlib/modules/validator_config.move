...
module ValidatorConfig {
    ...
    public fun consensus_pubkey(config: &Config): bytearray {
        config.consensus_pubkey
    }

    // Public accessor for network_identity_pubkey
    public fun network_identity_pubkey(config: &Config): bytearray {
        config.network_identity_pubkey
    }

    // Public accessor for network_signing_pubkey
    public fun network_signing_pubkey(config: &Config): bytearray {
