...
script{
    ...
    fun main(tc_account: signer) {
        ...
        /// check if VASP domain is added to VASPDomains
...
script{
    ...
    fun main(tc_account: signer) {
        ...
        /// add the same VASP domain to the bob account, expect it to fail
        VASPDomain::add_vasp_domain(tc_account, addr, copy domain_name);
...
script{
    ...
    fun main(tc_account: signer) {
        ...
        /// remove a VASP domain
        VASPDomain::remove_vasp_domain(tc_account, addr, copy domain_name);

        /// check if VASP domain is removed from VASPDomains
...
script{
    ...
    fun main(tc_account: signer) {
        ...
        /// check that VASP domain is not added to VASPDomains
