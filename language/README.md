...
* The most complete documentation of the Move IR syntax is the [grammar](compiler/ir_to_bytecode/syntax/src/syntax.lalrpop). You can also take a look at the [parser for the Move IR](compiler/ir_to_bytecode/src/parser.rs).
