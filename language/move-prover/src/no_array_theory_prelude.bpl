...
// return the sliced vector of a for the range [i, j)
function {:inline} SliceValueArray(a: ValueArray, i: int, j: int): ValueArray {
    ValueArray((lambda k:int :: if 0 <= k && k < j-i
                                then v#ValueArray(a)[i+k]
                                else DefaultValue),
...
// for functions).
axiom (forall v1,v2: Value :: IsEqual(v1, v2)
        ==> IsEqual($Hash_sha2_core(v1), $Hash_sha2_core(v2)));

// This says that Hash_sha2 is an injection
axiom (forall v1,v2: Value :: IsEqual($Hash_sha2_core(v1), $Hash_sha2_core(v2))
        ==> IsEqual(v1, v2));
...
axiom (forall v1,v2: Value :: IsEqual(v1, v2)
        ==> IsEqual($Hash_sha3_core(v1), $Hash_sha3_core(v2)));

axiom (forall v1,v2: Value :: IsEqual($Hash_sha3_core(v1), $Hash_sha3_core(v2))
        ==> IsEqual(v1, v2));
