...

{
    ...
    var debug#TestMultiplication#overflow_u8_mul_bad#0#x#75: Value;
    var debug#TestMultiplication#overflow_u8_mul_bad#1#y#75: Value;
    var debug#TestMultiplication#overflow_u8_mul_bad#2#__ret#191: Value;
    ...
    assume (debug#TestMultiplication#overflow_u8_mul_bad#0#x#75) == (x);
    assume IsValidU8(y);
    __m := UpdateLocal(__m, __frame + 1, y);
    assume (debug#TestMultiplication#overflow_u8_mul_bad#1#y#75) == (y);
    ...
    assume (debug#TestMultiplication#overflow_u8_mul_bad#2#__ret#191) == (__ret0);
    return;
...

{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestMultiplication#overflow_u8_mul_ok#0#x#273: Value;
    var debug#TestMultiplication#overflow_u8_mul_ok#1#y#273: Value;
    var debug#TestMultiplication#overflow_u8_mul_ok#2#__ret#373: Value;
    ...
    assume IsValidU8(x);
    __m := UpdateLocal(__m, __frame + 0, x);
    assume (debug#TestMultiplication#overflow_u8_mul_ok#0#x#273) == (x);
    assume IsValidU8(y);
    __m := UpdateLocal(__m, __frame + 1, y);
    assume (debug#TestMultiplication#overflow_u8_mul_ok#1#y#273) == (y);
    ...
    __ret0 := GetLocal(__m, __frame + 4);
    assume (debug#TestMultiplication#overflow_u8_mul_ok#2#__ret#373) == (__ret0);
    return;
...

{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestMultiplication#overflow_u64_mul_bad#0#x#456: Value;
    var debug#TestMultiplication#overflow_u64_mul_bad#1#y#456: Value;
    var debug#TestMultiplication#overflow_u64_mul_bad#2#__ret#576: Value;
    ...
    assume IsValidU64(x);
    __m := UpdateLocal(__m, __frame + 0, x);
    assume (debug#TestMultiplication#overflow_u64_mul_bad#0#x#456) == (x);
    assume IsValidU64(y);
    __m := UpdateLocal(__m, __frame + 1, y);
    assume (debug#TestMultiplication#overflow_u64_mul_bad#1#y#456) == (y);
    ...
    __ret0 := GetLocal(__m, __frame + 4);
    assume (debug#TestMultiplication#overflow_u64_mul_bad#2#__ret#576) == (__ret0);
    return;
...

{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestMultiplication#overflow_u128_mul_bad#0#x#858: Value;
    var debug#TestMultiplication#overflow_u128_mul_bad#1#y#858: Value;
    var debug#TestMultiplication#overflow_u128_mul_bad#2#__ret#982: Value;
    ...
    __m := UpdateLocal(__m, __frame + 0, x);
    assume (debug#TestMultiplication#overflow_u128_mul_bad#0#x#858) == (x);
    assume IsValidU128(y);
    __m := UpdateLocal(__m, __frame + 1, y);
    assume (debug#TestMultiplication#overflow_u128_mul_bad#1#y#858) == (y);
    ...
    __ret0 := GetLocal(__m, __frame + 4);
    assume (debug#TestMultiplication#overflow_u128_mul_bad#2#__ret#982) == (__ret0);
    return;
