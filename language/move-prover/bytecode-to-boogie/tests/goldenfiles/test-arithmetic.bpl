...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var debug#TestArithmetic#add_two_number#0#x#25: Value;
    var debug#TestArithmetic#add_two_number#1#y#25: Value;
    var debug#TestArithmetic#add_two_number#2#res#106: Value;
    var debug#TestArithmetic#add_two_number#3#z#133: Value;
    var debug#TestArithmetic#add_two_number#4#__ret#142: Value;
    var debug#TestArithmetic#add_two_number#5#__ret#142: Value;
    ...
    assume (debug#TestArithmetic#add_two_number#0#x#25) == (x);
    assume IsValidU64(y);
    __m := UpdateLocal(__m, __frame + 1, y);
    assume (debug#TestArithmetic#add_two_number#1#y#25) == (y);
    ...
    assume (debug#TestArithmetic#add_two_number#2#res#106) == (__tmp);
    ...
    assume (debug#TestArithmetic#add_two_number#3#z#133) == (__tmp);
    ...
    assume (debug#TestArithmetic#add_two_number#4#__ret#142) == (__ret0);
    __ret1 := GetLocal(__m, __frame + 9);
    assume (debug#TestArithmetic#add_two_number#5#__ret#142) == (__ret1);
    return;
...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestArithmetic#multiple_ops#0#x#173: Value;
    var debug#TestArithmetic#multiple_ops#1#y#173: Value;
    var debug#TestArithmetic#multiple_ops#2#z#173: Value;
    var debug#TestArithmetic#multiple_ops#3#res#242: Value;
    var debug#TestArithmetic#multiple_ops#4#__ret#281: Value;
    ...
    assume IsValidU64(x);
    __m := UpdateLocal(__m, __frame + 0, x);
    assume (debug#TestArithmetic#multiple_ops#0#x#173) == (x);
    assume IsValidU64(y);
    __m := UpdateLocal(__m, __frame + 1, y);
    assume (debug#TestArithmetic#multiple_ops#1#y#173) == (y);
    assume IsValidU64(z);
    __m := UpdateLocal(__m, __frame + 2, z);
    assume (debug#TestArithmetic#multiple_ops#2#z#173) == (z);
    ...
    __m := UpdateLocal(__m, __frame + 3, __tmp);
    assume (debug#TestArithmetic#multiple_ops#3#res#242) == (__tmp);

    call __tmp := CopyOrMoveValue(GetLocal(__m, __frame + 3));
    __m := UpdateLocal(__m, __frame + 9, __tmp);

    __ret0 := GetLocal(__m, __frame + 9);
    assume (debug#TestArithmetic#multiple_ops#4#__ret#281) == (__ret0);
    return;
...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestArithmetic#bool_ops#0#a#304: Value;
    var debug#TestArithmetic#bool_ops#1#b#304: Value;
    var debug#TestArithmetic#bool_ops#2#c#382: Value;
    var debug#TestArithmetic#bool_ops#3#d#437: Value;
    ...
    assume (debug#TestArithmetic#bool_ops#0#a#304) == (a);
    assume IsValidU64(b);
    __m := UpdateLocal(__m, __frame + 1, b);
    assume (debug#TestArithmetic#bool_ops#1#b#304) == (b);
    ...
    __m := UpdateLocal(__m, __frame + 2, __tmp);
    assume (debug#TestArithmetic#bool_ops#2#c#382) == (__tmp);
    ...
    __m := UpdateLocal(__m, __frame + 3, __tmp);
    assume (debug#TestArithmetic#bool_ops#3#d#437) == (__tmp);
...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestArithmetic#arithmetic_ops#0#a#547: Value;
    var debug#TestArithmetic#arithmetic_ops#1#b#547: Value;
    var debug#TestArithmetic#arithmetic_ops#2#c#622: Value;
    var debug#TestArithmetic#arithmetic_ops#3#__ret#686: Value;
    var debug#TestArithmetic#arithmetic_ops#4#__ret#686: Value;
    ...
    assume IsValidU64(a);
    __m := UpdateLocal(__m, __frame + 0, a);
    assume (debug#TestArithmetic#arithmetic_ops#0#a#547) == (a);
    assume IsValidU64(b);
    __m := UpdateLocal(__m, __frame + 1, b);
    assume (debug#TestArithmetic#arithmetic_ops#1#b#547) == (b);
    ...
    __m := UpdateLocal(__m, __frame + 2, __tmp);
    assume (debug#TestArithmetic#arithmetic_ops#2#c#622) == (__tmp);
...
Label_19:
    ...
    assume (debug#TestArithmetic#arithmetic_ops#3#__ret#686) == (__ret0);
    __ret1 := GetLocal(__m, __frame + 20);
    assume (debug#TestArithmetic#arithmetic_ops#4#__ret#686) == (__ret1);
    return;
...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestArithmetic#overflow#0#x#771: Value;
    var debug#TestArithmetic#overflow#1#y#799: Value;
    ...
    assume (debug#TestArithmetic#overflow#0#x#771) == (__tmp);
    ...
    assume (debug#TestArithmetic#overflow#1#y#799) == (__tmp);
...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestArithmetic#underflow#0#x#887: Value;
    var debug#TestArithmetic#underflow#1#y#897: Value;
    ...
    call __tmp := CopyOrMoveValue(GetLocal(__m, __frame + 2));
    __m := UpdateLocal(__m, __frame + 0, __tmp);
    assume (debug#TestArithmetic#underflow#0#x#887) == (__tmp);
    ...
    call __tmp := CopyOrMoveValue(GetLocal(__m, __frame + 5));
    __m := UpdateLocal(__m, __frame + 1, __tmp);
    assume (debug#TestArithmetic#underflow#1#y#897) == (__tmp);
...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var __frame: int;
    var __saved_m: Memory;
    var debug#TestArithmetic#div_by_zero#0#x#987: Value;
    var debug#TestArithmetic#div_by_zero#1#y#997: Value;
    ...
    call __tmp := CopyOrMoveValue(GetLocal(__m, __frame + 2));
    __m := UpdateLocal(__m, __frame + 0, __tmp);
    assume (debug#TestArithmetic#div_by_zero#0#x#987) == (__tmp);
    ...
    call __tmp := CopyOrMoveValue(GetLocal(__m, __frame + 5));
    __m := UpdateLocal(__m, __frame + 1, __tmp);
    assume (debug#TestArithmetic#div_by_zero#1#y#997) == (__tmp);
