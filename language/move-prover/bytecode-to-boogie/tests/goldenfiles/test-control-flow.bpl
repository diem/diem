...
requires ExistsTxnSenderAccount(__m, __txn);
{
    ...
    var debug#TestControlFlow#branch_once#0#cond#117: Value;
    var debug#TestControlFlow#branch_once#1#__ret#180: Value;
    var debug#TestControlFlow#branch_once#1#__ret#206: Value;
    ...
    assume (debug#TestControlFlow#branch_once#0#cond#117) == (cond);
    ...
    assume (debug#TestControlFlow#branch_once#1#__ret#180) == (__ret0);
    return;
...
Label_6:
    ...
    assume (debug#TestControlFlow#branch_once#1#__ret#206) == (__ret0);
    return;
