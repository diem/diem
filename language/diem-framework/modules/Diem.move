...
module Diem {
    ...
    acquires CurrencyInfo, MintCapability {
        ...
        assert(exists<MintCapability<CoinType>>(addr), DiemErrors::requires_capability(EMINT_CAPABILITY));
    ...
    spec mint {
        ...
        aborts_if !exists<MintCapability<CoinType>>(Signer::spec_address_of(account)) with DiemErrors::REQUIRES_CAPABILITY;
    ...
    public fun burn<CoinType: store>(
        ...
        let addr = Signer::address_of(account);
        assert(exists<BurnCapability<CoinType>>(addr), DiemErrors::requires_capability(EBURN_CAPABILITY));
    ...
    spec schema BurnAbortsIf<CoinType> {
        ...
        aborts_if !exists<BurnCapability<CoinType>>(Signer::spec_address_of(account)) with DiemErrors::REQUIRES_CAPABILITY;
