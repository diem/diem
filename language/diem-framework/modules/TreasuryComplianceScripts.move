...
module TreasuryComplianceScripts {
    ...
    /// | `Errors::INVALID_ARGUMENT` | `VASPDomain::EVASP_DOMAIN_ALREADY_EXISTS`         | The `domain` already exists in the list of `VASPDomain::VASPDomain`s  in the `VASPDomain::VASPDomains` resource published under `address`. |
