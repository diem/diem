...
use language_e2e_tests::{
    account, test_with_different_versions, versioning::CURRENT_RELEASE_VERSIONS,
};
...
fn account_limits() {
    test_with_different_versions! {CURRENT_RELEASE_VERSIONS, |test_env| {
        ...
        let diem_root = test_env.dr_account;
        ...
        executor.execute_and_apply(
            dd.transaction()
                ...
                .sequence_number(test_env.dd_sequence_number.checked_add(1).unwrap())
                .ttl(ttl)
                .sign(),
        );
        ...
        executor.execute_and_apply(
            blessed
                ...
                .sequence_number(test_env.tc_sequence_number.checked_add(3).unwrap())
                .ttl(ttl)
                .sign(),
        );
...

        {
            ...
            let output = executor.execute_transaction(
                dd.transaction()
                    ...
                    .sequence_number(test_env.dd_sequence_number.checked_add(2).unwrap())
                    .ttl(ttl)
                    .sign(),
            );
            assert_aborted_with(output, 776);
        ...
        executor.execute_and_apply(
            blessed
                ...
                .sequence_number(test_env.tc_sequence_number.checked_add(4).unwrap())
                .ttl(ttl)
                .sign(),
        );
        ...
        // Set vasp A's max holding to its current balance across all accounts
        {
            ...
            executor.execute_and_apply(
                blessed
                    ...
                    .sequence_number(test_env.tc_sequence_number.checked_add(5).unwrap())
                    .ttl(ttl)
                    .sign(),
            );
            ...
            executor.execute_and_apply(
                blessed
                    ...
                    .sequence_number(test_env.tc_sequence_number.checked_add(6).unwrap())
                    .ttl(ttl)
                    .sign(),
            );
        }
