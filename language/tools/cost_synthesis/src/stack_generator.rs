    ...
    'alloc: 'txn,
{
    ...
    fn next_user_string(&mut self, is_padding: bool) -> UserString {
    ...
    fn next_stack_value(&mut self, stk: &[Local], is_padding: bool) -> Local {
        match self.gen.gen_range(0, 5) {
            ...
            2 => Local::user_string(self.next_user_string(is_padding)),
    ...
    fn resolve_to_value(&mut self, sig_token: &SignatureToken, stk: &[Local]) -> Local {
        match sig_token {
            ...
            SignatureToken::String => Local::user_string(self.next_user_string(false)),
