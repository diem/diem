...
module LibraConfig {
    ...
    public fun initialize_configuration(sender: &Sender::T) {
        ...
        move_to_sender<Configuration>(Configuration {
            ...
            events: Event::new_event_handle<NewEpochEvent>(sender),
        });
    }
    ...
    public fun publish_new_config<Config: copyable>(payload: Config, sender: &Sender::T) {
        // TODO: impose proper permission checks
        // Callable by the any address for now.
    ...
    public fun reconfigure(sender: &Sender::T) acquires Configuration {
