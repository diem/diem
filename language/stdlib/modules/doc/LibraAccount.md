...
-  [Function `add_preburn_from_tc`](#0x1_LibraAccount_add_preburn_from_tc)
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_add_parent_vasp_role_from_association">add_parent_vasp_role_from_association</a>(parent_vasp_creation_capability: &<a href="Roles.md#0x1_Roles_Capability">Roles::Capability</a>&lt;<a href="Roles.md#0x1_Roles_AssociationRootRole">Roles::AssociationRootRole</a>&gt;, addr: address, human_name: vector&lt;u8&gt;, base_url: vector&lt;u8&gt;, compliance_public_key: vector&lt;u8&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_add_parent_vasp_role_from_association">add_parent_vasp_role_from_association</a>(
    ...
    <a href="Roles.md#0x1_Roles_add_privilege_to_account_parent_vasp_role">Roles::add_privilege_to_account_parent_vasp_role</a>(&account, <a href="Roles.md#0x1_Roles_parent_vasp_role_TESTNET_HACK">Roles::parent_vasp_role_TESTNET_HACK</a>());
...
<a name="0x1_LibraAccount_add_preburn_from_tc"></a>

## Function `add_preburn_from_tc`



<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_add_preburn_from_tc">add_preburn_from_tc</a>&lt;Token&gt;(preburn_creation_capability: &<a href="Roles.md#0x1_Roles_Capability">Roles::Capability</a>&lt;<a href="Roles.md#0x1_Roles_TreasuryComplianceRole">Roles::TreasuryComplianceRole</a>&gt;, addr: address)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_add_preburn_from_tc">add_preburn_from_tc</a>&lt;Token&gt;(
    preburn_creation_capability: &Capability&lt;TreasuryComplianceRole&gt;,
    addr: address,
) {
    <b>assert</b>(<a href="#0x1_LibraAccount_exists_at">exists_at</a>(addr), 0);
    <b>let</b> account = <a href="#0x1_LibraAccount_create_signer">create_signer</a>(addr);
    <a href="Libra.md#0x1_Libra_publish_preburn_to_account">Libra::publish_preburn_to_account</a>&lt;Token&gt;(&account, preburn_creation_capability);
    <a href="#0x1_LibraAccount_destroy_signer">destroy_signer</a>(account);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_create_config_account">create_config_account</a>&lt;Token&gt;(creator_account: &signer, _: &<a href="Roles.md#0x1_Roles_Capability">Roles::Capability</a>&lt;<a href="LibraConfig.md#0x1_LibraConfig_CreateOnChainConfig">LibraConfig::CreateOnChainConfig</a>&gt;, new_account_address: address, auth_key_prefix: vector&lt;u8&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_create_config_account">create_config_account</a>&lt;Token&gt;(
    creator_account: &signer,
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_create_root_association_account">create_root_association_account</a>&lt;Token&gt;(new_account_address: address, auth_key_prefix: vector&lt;u8&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="#0x1_LibraAccount_create_root_association_account">create_root_association_account</a>&lt;Token&gt;(
    new_account_address: address,
    auth_key_prefix: vector&lt;u8&gt;,
) {
    <b>assert</b>(<a href="LibraTimestamp.md#0x1_LibraTimestamp_is_genesis">LibraTimestamp::is_genesis</a>(), 0);
