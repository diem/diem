...
module Offer {
  ...
  public fun create<Offered>(offered: Offered, for: address, sender: &Sender::T) {
  ...
  public fun redeem<Offered>(offer_address: address, sender: &Sender::T): Offered acquires T {
    ...
    Transaction::assert(sender_address == for || sender_address == offer_address, 11);
    offered
  }
