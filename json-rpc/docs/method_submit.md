...
|-------|----------|------------------------------------------------------------------------------------------------------|
| data  | string   | Signed transaction data - hex-encoded bytes of [LCS][1] serialized Libra [SignedTransaction][3] type.|
...
* There is no partial execution in Libra, hence the transaction either has full effect or has no effect at all.
