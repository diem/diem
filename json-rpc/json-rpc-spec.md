...
---
## **get_account_transactions** - method
...
<table>
  ...
  <tr>
   ...
   <td>The start of sequence number
   </td>
  </tr>
  <tr>
   <td><strong>limit</strong>
   ...
   <td>The start of sequence number to return
   </td>
  </tr>
  <tr>
   <td><strong>limit</strong>
   ...
   <td>The maximum number of transactions to return.
   </td>
  </tr>
  <tr>
   <td><strong>include_events</strong>
...
curl -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"get_account_transaction","params":["c1fda0ec67c1b87bfb9e883e2080e530", 0, 100, false],"id":1}'
...
<table>
  ...
  <tr>
   ...
   <td>Array of <a href="#amount---type">Amount</a> objects
   </td>
