...
pub fn add_to_network(
    ...
    network.add_protocol_handler(endpoint_config())
}

/// Returns the configuration information for the tx/rx endpoints connected to StateSynchronizer.
pub fn endpoint_config() -> (
    ...
    (
        /* rpc_protocols = */ vec![],
        /* direct_send_protocols = */ vec![ProtocolId::StateSynchronizerDirectSend],
        /* queue_preference = */ QueueStyle::LIFO,
        /* max_queue_size_per_peer = */ 1,
        /* counter = */ Some(&counters::PENDING_STATE_SYNCHRONIZER_NETWORK_EVENTS),
    )
}
