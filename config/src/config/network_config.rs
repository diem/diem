...
pub const IP_BYTE_BUCKET_RATE: usize = MAX_FRAME_SIZE;
...
pub struct NetworkConfig {
    ...
    // Maximum inbound number of bytes/s for an IP
    pub inbound_ip_byte_bucket_rate: usize,
    // Maximum inbound burst of bytes for an IP
    pub inbound_ip_byte_bucket_size: usize,
    // Maximum outbound number of bytes/s for an IP
    pub outbound_ip_byte_bucket_rate: usize,
    // Maximum outbound burst of bytes for an IP
    pub outbound_ip_byte_bucket_size: usize,
}
...
impl NetworkConfig {
    pub fn network_with_id(network_id: NetworkId) -> NetworkConfig {
        let mut config = Self {
            ...
            inbound_ip_byte_bucket_rate: IP_BYTE_BUCKET_RATE,
            inbound_ip_byte_bucket_size: IP_BYTE_BUCKET_SIZE,
            outbound_ip_byte_bucket_rate: IP_BYTE_BUCKET_RATE,
            outbound_ip_byte_bucket_size: IP_BYTE_BUCKET_SIZE,
        };
