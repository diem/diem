...
fn test_key_manager_consensus_rotation() {
    ...
    key_manager_config.rotation_period_secs = 30;
    key_manager_config.sleep_period_secs = 10000; // Large sleep to force a single rotation
    ...
    // Wait for enough time to elapse for a key rotation to be required and then spawn the key
    // manager.
